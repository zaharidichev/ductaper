...
class ChannelThinWrapper(private val c: Channel) {
  ...
  @throws[IOException]
  def queueDeclare(queue: String,
                   durable: Boolean,
                   exclusive: Boolean,
                   autoDelete: Boolean,
                   arguments: Map[String, AnyRef]): Queue.DeclareOk = {
  ...
  @throws[IOException]
  def exchangeDeclare(exchange: String,
                      exchangeType: String,
                      durable: Boolean,
                      autoDelete: Boolean,
                      arguments: Map[String, AnyRef]): Exchange.DeclareOk = {
